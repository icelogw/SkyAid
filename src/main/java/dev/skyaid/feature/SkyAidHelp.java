...
public final class SkyAidHelp {
	...
	private static final Entry[] COMMANDS = {
			...
			new Entry("/skyaid mouselock set <yaw> <pitch>", "glide to an angle for 3s", false),
			new Entry("/skyaid museum", "your museum: donated and missing", true),
			new Entry("/skyaid museum value", "cheapest museum XP at live prices", true),
